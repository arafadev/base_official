...
@section('title', __('admin.regions_page'))
...
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="mb-2 page-title">{{ __('admin.regions') }}</h2>
                <hr>
                ...
                <div class="page-title-right">
                    ...
                    <a id="delete-selected" class="btn btn-danger" style="display: none;"
                        data-route="{{ route('admin.regions.deleteSelected') }}">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center" style="color: black; font-weight: 600;">
                                                    {{ __('admin.region_name') }}</th>
                                                <th class="text-center" style="color: black; font-weight: 600;">
                                                    {{ __('admin.country_name') }}</th>
                                                <th class="text-center" style="color: black; font-weight: 600;">
                                        ...
                                        <tbody>
                                            @forelse ($regions as $region)
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ $region->created_at->diffForHumans() }}
                                                    </td>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <a href="#" class="icon-link delete"
                                                            data-id="{{ $region->id }}"
                                                            data-route="{{ route('admin.regions.delete', $region->id) }}">
