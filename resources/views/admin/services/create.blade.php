...
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="h5 page-title">{{ __('admin.create_service') }}</h2>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <x-input id="title" name="title" label="{{ __('admin.title') }}"
                                        placeholder="{{ __('admin.enter_title') }}" :required="true" />
                                </div>
                                <div class="col-md-6">
                                    <x-input id="icon" name="icon" label="{{ __('admin.icon') }}"
                                        placeholder="{{ __('admin.enter_icon') }}" :required="true" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <x-textarea id="description" name="description" label="{{ __('admin.description') }}"
                                        placeholder="{{ __('admin.enter_description') }}" :required="true" />
                                </div>
                            </div>
                            <div>
