        ...
        <div class="row justify-content-center">
            <div class="col-12">
                ...
                <div class="card shadow">
                    <div class="card-body">
                        <form action="{{ route('admin.role.roles_has_permission.update', $role->id) }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="col-md-6">
                                        <x-input id="name" name="role_id" label="{{ __('admin.role') }}"
                                            placeholder="{{ __('admin.enter_role') }}" :value="$role->name"
                                            :disabled="true" />
                                    </div>
                                </div>
                            </div>
