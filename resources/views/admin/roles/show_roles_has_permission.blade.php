...
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="mb-2 page-title">{{ __('admin.roles') }}</h2>
                <hr>
                ...
                <div class="page-title-right">
                    ...
                    <a id="delete-selected" class="btn btn-danger" style="display: none;"
                        data-route="{{ route('admin.roles.deleteSelected') }}">
                                        ...
                                        <tbody>
                                            @forelse ($roles as $role)
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{ $role->created_at->diffForHumans() }}
                                                    </td>

                                                    {{-- Actions --}}
                                                    <td class="text-center">
                                                        <a href="{{ route('admin.role.edit_roles_has_permission.edit', $role->id) }}"
                                                            class="icon-link edit">
                                                            <i class="fe fe-edit fe-16"></i>
                                                        </a>
                                                        <a href="#" class="icon-link delete"
                                                            data-id="{{ $role->id }}"
                                                            data-route="{{ route('admin.roles.delete', $role->id) }}">
